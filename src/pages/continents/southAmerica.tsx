		...
		<Box>
			...
			>
				...
				<SimpleGrid columns={[1, 3, 4 ]} spacing="10" ml="10">
					<Box h="250">
						<Image src="../../../assets/southAmerica/brasil.jpeg" alt="Rio de Janeiro" w="100%" h="130" />
					...
					<Box h="279px">
						<Image src="../../../assets/southAmerica/chile.jpeg" alt="Santiago" w="100%" h="130" />
						<Text color="gray.800" fontWeight="bold" m="3">Santiago</Text>
						<Text color="gray.400" fontSize="sm" fontWeight="bold" m="3">Chile</Text>
					</Box>
					<Box h="279px">
						<Image src="../../../assets/southAmerica/argentina.jpeg" alt="Buenos Aires" w="100%" h="130" />
					...
					<Box h="279px">
						<Image src="../../../assets/southAmerica/colombia.jpeg" alt="Bolivar" w="100%" h="130" />
						<Text color="gray.800" fontWeight="bold" m="3">Bolivar</Text>
						<Text color="gray.400" fontSize="sm" fontWeight="bold" m="3">Colombia</Text>
					</Box>
					<Box h="279px">
						<Image src="../../../assets/southAmerica/peru.jpeg" alt="Cercado de Lima" w="100%" h="130" />
